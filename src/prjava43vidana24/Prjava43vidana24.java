package prjava43vidana24; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43vidana24 extends Frame 
   ...
   public Prjava43vidana24 () { 
      ...
      setTitle("nova finestra prjava43vidana24");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43vidana24();  // Let the construct do the job 
   } 
